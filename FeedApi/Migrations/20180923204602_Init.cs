...
namespace FeedApi.Migrations
{
    public partial class Init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "FeedCollectionsFeeds",
                columns: table => new
                {
                    Id = table.Column<long>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    FeedId = table.Column<long>(nullable: false),
                    FeedCollectionId = table.Column<long>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_FeedCollectionsFeeds", x => x.Id);
                    table.ForeignKey(
                        name: "FK_FeedCollectionsFeeds_FeedCollections_FeedCollectionId",
                        column: x => x.FeedCollectionId,
                        principalTable: "FeedCollections",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_FeedCollectionsFeeds_Feeds_FeedId",
                        column: x => x.FeedId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FeedCollectionsFeeds_FeedCollectionId",
                table: "FeedCollectionsFeeds",
                column: "FeedCollectionId");

            migrationBuilder.CreateIndex(
                name: "IX_FeedCollectionsFeeds_FeedId",
                table: "FeedCollectionsFeeds",
                column: "FeedId");
        }
